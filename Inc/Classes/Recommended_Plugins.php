...
use JLTAUTHORBIO\Libs\Recommended;
	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'wp-author-bio',       // Ex. awesome-wp-author-bio-settings /  edit.php?post_type=page .
				__( 'Recommended', 'awesome-wp-author-bio' ),
				__( 'Recommended', 'awesome-wp-author-bio' ),
				'manage_options',
				'awesome-wp-author-bio-recommended-plugins',
